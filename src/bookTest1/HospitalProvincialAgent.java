...
public class HospitalProvincialAgent extends Agent {
	...
	protected void setup(){
		...
		Agency agency = new Agency("Hospital provincial", "Descripcion hospital", "Otra cosa", location, new ArrayList<Resource>());
